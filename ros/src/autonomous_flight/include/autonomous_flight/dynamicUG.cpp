...
namespace AutoFlight{
    dynamicUG::dynamicUG(const ros::NodeHandle& nh, const std::string robot_ns) : flightBase(nh, robot_ns){
		...
		this->getRoadmapServer_ = this->nh_.advertiseService(prefix + "/dep/get_roadmap", &dynamicUG::getRoadmapServiceCB, this);
		this->resetRoadmapServer_ = this->nh_.advertiseService(prefix + "/dep/reset_roadmap", &dynamicUG::resetRoadmapServiceCB, this);
	...
	void dynamicUG::initModules(){
		...
		this->expPlanner_.reset(new globalPlanner::CAN (this->nh_, this->robot_ns_));
