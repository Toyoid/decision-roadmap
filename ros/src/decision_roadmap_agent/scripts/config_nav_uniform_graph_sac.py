...
class UniformGraphRMArgs:
    ...
    env_name: str = "Uniform-graph-Navigation"
    ...
    k_neighbor_size: int = 40  # nearest_neighbor_number (in .cpp) + 1
...
def get_config_uniform_graph(parse_cli_args=False):
    if parse_cli_args:
        return tyro.cli(UniformGraphRMArgs)
    else:
        return UniformGraphRMArgs()
