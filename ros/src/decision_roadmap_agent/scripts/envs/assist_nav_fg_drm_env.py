...
class AssistNavFrontierGuidedDRMEnv(AssistNavEnvBase):
    """
    ...
    def __init__(
        ...
        super().__init__(args, robot_namespace, other_robot_namespace, drm_name, is_train)
    ...
    def _get_next_state(self):
        ...
        try:
            ...
            rospy.logwarn(f"GetRoadmap Service Failed: {e}")
        ...
        targets = np.array(list(self.target_positions.values()), dtype=np.float64)[:, :2]  # (n_targets, 2)
