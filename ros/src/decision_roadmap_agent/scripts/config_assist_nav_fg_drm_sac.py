...
class FrontierGuidedDRMArgs:
    ...
    env_name: str = "AssistNav-Frontier-guided-DRM"
    ...
    batch_size: int = 1 # 64  # 32 seems quite good
    ...
    node_padding_size: int = 28  # maybe still 25?
