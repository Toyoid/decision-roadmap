...
*	File: fg_drm.h
*	---------------
*   frontier-guided decision roadmap header file
*/
...
namespace globalPlanner{
    ...
    public:
        FGDRM(const ros::NodeHandle& nh, const std::string& robot_ns);
        ...
        void filterBestViewCandidates(std::vector<std::shared_ptr<PRM::Node>>& goalCandidates);
        ...
        visualization_msgs::MarkerArray buildFrontierRoadmapMarkers(); // Add this line
